...
alias prodeploy="bundle exec cap deploy"
alias log="tail -f log/development.log"
alias stalog="bundle exec cap production log:rails"
...
alias sk="bundle exec sidekiq -q low -q default -q processing -q critical"